...
export const PALETTES = {
  ...
  ruby: {
    gems: "Ruby", natural: "Sunset", flower: "Rose", beverage: "Sangria", pigment: "Carmine",
    main:    "#363f6b",
  ...
  gold: {
    gems: "Gold", natural: "Autumn", flower: "Marigold", beverage: "Brandy", pigment: "Umber",
    main:    "#987b60",
  ...
  anthracite: {
    gems: "Anthracite", natural: "Spring", flower: "Sunflower", beverage: "Gin", pigment: "Charcoal",
    main:    "#1d2019",
    accents: ["#ff6e0b", "#f0c038"],
  },
  ...
  amber: {
    gems: "Amber", natural: "Cyclone", flower: "Daisy", beverage: "Whisky", pigment: "Sienna",
    main:    "#3a4160",
    accents: ["#ff6e0b", "#f0c038"],
  },
  ...
  diamond: {
    gems: "Diamond", natural: "Typhoon", flower: "Magnolia", beverage: "Bourbon", pigment: "Slate",
    main:    "#3a4160",
  ...
  onyx: {
    gems: "Onyx", natural: "Summer", flower: "Olive", beverage: "Cappuccino", pigment: "Khaki",
    main:    "#987b60",
  ...
  topaz: {
    gems: "Topaz", natural: "Lagoon", flower: "Agave", beverage: "Mojito", pigment: "Turquoise",
    main:    "#26434c",
  ...
  sapphire: {
    gems: "Sapphire", natural: "Midnight", flower: "Lavender", beverage: "Curaçao", pigment: "Indigo",
    main:    "#362e4a",
  ...
  amethyst: {
    gems: "Amethyst", natural: "Twilight", flower: "Orchid", beverage: "Cognac", pigment: "Tyrian",
    main:    "#3f2c52",
  ...
  opal: {
    gems: "Opal", natural: "Morning", flower: "Sakura", beverage: "Sake", pigment: "Coral",
    main:    "#2c3a56",
  ...
  tourmaline: {
    gems: "Tourmaline", natural: "Mist", flower: "Iris", beverage: "Baijiu", pigment: "Lilac",
    main:    "#584858",
  ...
  marble: {
    gems: "Marble", natural: "Dusk", flower: "Maple", beverage: "Cider", pigment: "Cobalt",
    main:    "#6289ac",
  ...
  agate: {
    gems: "Agate", natural: "Mountain", flower: "Oak", beverage: "Liquor", pigment: "Sepia",
    main:    "#72635b",
  ...
  quartz: {
    gems: "Quartz", natural: "Arctic", flower: "Edelweiss", beverage: "Schnapps", pigment: "Graphite",
    main:    "#686868",
 ...
 * Structure: { gems: { en, es, ... }, natural: { ... }, flower: { ... }, beverage: { ... }, pigment: { ... } }
 */

 ...
 * All public functions accept and return hex RGB strings (#RRGGBB).
 */
...
/**
 * Legacy: generate n-colour palette from a single hex (backward compat).
 * Full black-to-white range, equidistant by lightness.
 */
function _generateRgbPalette(hex, n, mode, power) {
    const arc = _buildExcolorArc(hex, mode, power, Math.max(1000, n * 10));
    return _sampleArcRange(arc, n, 0, 1, 0);
}
...
export {
    ...
    generateColorPath,
    generateLightnessStep,
    generateLightnessPath,
    generateLightnessGrades,
};
